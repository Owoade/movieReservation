...
if (isset($_POST['go'])) {
  ...
  $title = $_POST['food'];
  $amount = $_POST['drink'];
  $insert = "insert into food(Name, Food, Drink ) values('$name', '$title', '$amount')";
...
<body>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<div class="search-right">
							<a href="./choose.php" class="btn search-hny mr-lg-3 mt-lg-0 mt-4" title="search">Book Now</span></a>
							<!-- search popup -->
	...
	<div class="w3l-breadcrumbs">
		<nav id="breadcrumbs" class="breadcrumbs">
			...
			<a href="index.php">Home</a> » <span class="breadcrumb_last" aria-current="page">Food & Drinks</span>
			</div>
		</nav>
	</div>
 <!--//breadcrumbs -->
		...
		<div class="contacts-9 py-5">
		  <div class="container py-lg-4">
			<div class="headerhny-title text-center">
				<h4 class="sub-title text-center">FOODs & DRINKs</h4>
				<h3 class="hny-title mb-0">Book Food & Drink</h3>
				<p class="hny-title mb-lg-5 mb-4">Book for your favourite food and drink in the cinema to have a wonderful experience.</p>
			</div>
			<div class="contact-view mt-lg-5 mt-4">
			  <div class="conhny-form-section">
				<form action="food.php" method="post" class="formhny-sec">
						<div class="form-grids">
							<div class="form-input">
								<input type="text" name="name" id="w3lName" placeholder="Enter your name *" required/>
							</div>
							<div class="form-input">
							<select name="food" id="w31Name" required>
                            <option value="">Select Foods</option>
                            <option value="Pop-corn #500">Pop-corn #500</option>
                            <option value="Pop-corn #1,000">Pop-corn #1,000</option>
                            <option value="Pop-corn #1,500">Pop-corn #1,500</option>
                            <option value="Pop-corn #2,000">Pop-corn #2,000</option>
                            <option value="Pop-corn #2,500">Pop-corn #2,500</option>
                            <option value="Pop-corn #3,000">Pop-corn #3,000</option>
                            </select>

							</div>
							<div class="form-input">
                            <select name="drink" id="w31Name">
                            <option value="">Select Drinks</option>
                            <option value="Pepsi">Pepsi</option>
                            <option value="Smoove">Smoove</option>
                            <option value="Coca-Cola">Coca-Cola</option>
                            <option value="Pulp Apple">Pulp Apple</option>
                        </select>
							</div>
						</div>
						<div class="submithny text-right mt-4">
							<button name="go" class="btn read-button">Submit</button>
						</div>
					</form>
			  </div>
				...
				<div class="contact-info-left d-grid">
					<div class="contact-info">
						...
						<div class="contact-details">
							<h4>Address:</h4>
							<p>Federal College Of Animal Health And Production Technology</p>
						</div>
					</div>
					<div class="contact-info">
						<div class="icon">
					...
					<div class="contact-info">
						...
						<div class="contact-details">
							<h4>Mail:</h4>
							<p><a href="mailto:popoolarofih@gmail.com" class="email">info@proshowz.com</a></p>
							<p><a href="mailto:popoolarofih@gmail.com" class="email">proshowz@support.com</a></p>
						</div>
					</div>
				</div>
			</div>
