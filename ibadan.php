...
if (isset($_POST['go'])) {
  ...
  $insert = "insert into ibadan(Name, user_hash, Title, Date, Location, Phone, time, seat, Dateweek) values('$name', '$hash', '$title', '$amount', '$email', '$gmail', '$reserve', '$seat', '$week')";
...
<body>
    <div class="container">
        ...
        <form class="form-group" action="./booking.php" method="POST">
            <div id="form">
                <h1 class="text-white text-center">Book Ticket</h1>
