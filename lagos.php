...
if (isset($_POST['go'])) {
  ...
  $insert = "insert into lagos(Name, user_hash, Title, Date, Phone, time, seat, Dateweek) values('$name', '$hash', '$title', '$amount', '$gmail', '$reserve', '$seat', '$week')";
...
<body>
    <div class="container">
        <h2>Book Ticket</h2>
        <form class="form-group" action="./lagos.php" method="POST">
            <div id="form">
                <h1 class="text-white text-center">Book Ticket - Watts Cinema,Lagos,Nigeria</h1>
        ...
        </form> <a href="./ticket3.php"><button  id="submit-btn" >View Ticket</button></a>
    </div>
